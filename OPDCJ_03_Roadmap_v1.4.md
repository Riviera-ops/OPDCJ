...
> **Version : v1.4** · 14 juin 2026 · App ciblée : **OPDCJ V21.54**
> Fichier : `OPDCJ_03_Roadmap_v1.4.md` (remplace v1.3)
...
> *v1.4 : sprint 13–14 juin 2026 — Chantier UI 13 points · Audit moteur V21.37 · correctifs F-1.1 / F-1.2 / C-1 / C-2 · harnais 33 tests.*

---

## 1. Périmètre fonctionnel actuel (V21.54)
...
- **Harnais de tests** (`tests/engine.test.js`, Node.js) : 33 assertions anti-régression. À exécuter après chaque chantier moteur.
...
6. **Tests des formules** : ✅ **Fait V21.52** — harnais `tests/engine.test.js` (Node.js, 33 assertions) couvrant conservation des masses, poids cuit, modèle T°, 3T, glace, coûts, biga, débordement.
...
5. ✅ **Audit moteur — correctifs F-1.1/F-1.2/C-1/C-2** — fait V21.52-V21.54
