...
> **Version : v1.5** · 14 juin 2026 · App ciblée : **OPDCJ V21.56**
> Fichier : `OPDCJ_03_Roadmap_v1.5.md` (remplace v1.4)
...
> *v1.5 : itération V21.55-V21.56 — correctifs des correctifs (biga refT=18, mode guard pBexTotal, résidu Q10=2 hint, inversion sign `applyQ10Correction`). Harnais étendu à 46 tests.*

---

## 1. Périmètre fonctionnel actuel (V21.56)
...
- **Harnais de tests** (`tests/engine.test.js`, Node.js) : 46 assertions anti-régression (8 + 3 groupes ajoutés V21.55-V21.56 pour biga refT, mode guard pBex, hint Q10). À exécuter après chaque chantier moteur.
...
6. **Tests des formules** : ✅ **Fait V21.52, étendu V21.55-V21.56** — harnais `tests/engine.test.js` (Node.js, 46 assertions) couvrant conservation des masses, poids cuit, modèle T°, 3T, glace, coûts, biga, débordement, refT biga, guard pBex, hint Q10.
...
6. ⚪ **Autolyse** (§4.3) — à attaquer
7. ⚪ **Chronomètre** (§4.4) — à attaquer
